...
with open('Kino Vote 2021-03-10.csv') as f:
    lines = list(csv.reader(f))

Q1 = [line[4:] for line in lines]
print(ranked_vote(Q1, 4, False))

Q1 = [[line[6], line[10]] for line in lines]
print(ranked_vote(Q1, 1, False))

Q1 = [line[4:6] + line[7:] for line in lines]
print(ranked_vote(Q1, 4, False))

Q1 = [line[4:10] + line[11:] for line in lines]
print(ranked_vote(Q1, 4, False))