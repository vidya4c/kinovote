...
with open('Kino vote 5th January 2021.csv') as f:
    lines = list(csv.reader(f))

Q1 = [line[1:10] for line in lines]
print(ranked_vote(Q1, 3, True))

Q2 = [line[10:18] for line in lines]
print(ranked_vote(Q2, 3, True))

Q3 = [line[18:24] for line in lines]
print(ranked_vote(Q3, 3, True))