...
with open('Kino Vote 2021-06-24.csv') as f:
    lines = list(csv.reader(f))

Q1 = [line[2:13] for line in lines]
print(ranked_vote(Q1, 3, False))

Q1 = [line[13:23] for line in lines]
print(ranked_vote(Q1, 3, False))

Q1 = [line[24:31] for line in lines]
print(ranked_vote(Q1, 3, False))

Q1 = [line[31:37] + line[38:42] for line in lines]
print(ranked_vote(Q1, 3, False))
