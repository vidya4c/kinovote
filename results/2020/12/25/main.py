...
def ranked_vote(table, places):
    ...
    election_result = single_transferable_vote(themes, ballots, places, hare=True)
...
Q1 = [line[1:15] for line in lines]
Q2 = [line[15:24] for line in lines]

print(ranked_vote(Q1, 3))

print(ranked_vote(Q2, 4))